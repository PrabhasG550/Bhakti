...
export default function Home() {
  ...
  const handleUpdateProfile = (name: string, address: string, image: string | null) => {
    setUserName(name);
            ...
            <div className="flex-shrink-0 flex items-center gap-3">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-white border-2 border-zinc-300 hover:border-zinc-400 transition-colors overflow-hidden"
                  aria-label="Profile"
                >
                  {userImage ? (
                    <img
