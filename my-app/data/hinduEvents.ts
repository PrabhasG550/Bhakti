...
// Hindu festivals and events for 2026
// Dates are based on the Hindu calendar and may vary by region
export const hinduEvents: HinduEvent[] = [
  // JANUARY 2026
  {
    id: '1',
    name: 'Lohri',
    description: 'A popular winter folk festival celebrated primarily in Punjab, marking the end of winter and the arrival of longer days. Celebrated with bonfires, folk songs, and traditional dances.',
    date: new Date(2026, 0, 13), // January 13, 2026
    type: 'festival',
    significance: 'Celebrates the end of winter solstice and the beginning of longer days. The bonfire represents the sun and is believed to bring warmth and prosperity.',
    culturalContext: 'Lohri reflects the agricultural roots of Indian culture, celebrating the harvest season. The festival brings communities together around bonfires, showcasing the importance of community bonding in Indian culture.',
    traditions: ['Lighting bonfires', 'Singing folk songs', 'Traditional dances (Bhangra and Gidda)', 'Distributing peanuts, popcorn, and sweets', 'Offering prayers for a good harvest'],
  ...
  },
  {
    id: '3',
    name: 'Pongal',
    description: 'A four-day harvest festival celebrated in Tamil Nadu, marking the end of the winter solstice. The festival is named after the traditional dish "Pongal" made from newly harvested rice.',
    date: new Date(2026, 0, 14), // January 14, 2026 (first day)
    type: 'festival',
    significance: 'Celebrates the harvest and thanks nature for the abundance. The festival marks the beginning of the Tamil month of Thai, considered highly auspicious.',
    culturalContext: 'Pongal showcases the agricultural traditions of South India and the deep respect for nature and animals (especially cows) in Indian culture. The festival teaches about gratitude for natural resources and the importance of preserving traditional farming practices.',
    traditions: ['Cooking Pongal dish in earthen pots', 'Decorating homes with Kolam (rangoli)', 'Worshipping cattle (Mattu Pongal)', 'Offering prayers to the Sun God', 'Family gatherings and feasts'],
  ...
  // APRIL 2026
  {
    ...
    date: new Date(2026, 3, 2), // April 2, 2026
    type: 'festival',
  ...
  // JUNE 2026
  {
    ...
    date: new Date(2026, 5, 19), // June 19, 2026
    type: 'festival',
  ...
  // SEPTEMBER 2026
  {
    ...
    date: new Date(2026, 8, 4), // September 4, 2026
    type: 'festival',
  ...
  },
  {
    id: '17',
    name: 'Onam',
    description: 'A major harvest festival of Kerala, celebrating the homecoming of the legendary King Mahabali. One of the most vibrant and culturally rich festivals, featuring elaborate feasts, traditional dances, and flower decorations.',
    date: new Date(2026, 8, 24), // September 24, 2026 (first day)
    type: 'festival',
    significance: 'Celebrates the legendary King Mahabali, who was known for his righteousness and generosity. The festival marks the harvest season and is a celebration of Kerala\'s rich culture and traditions.',
    culturalContext: 'Onam reflects the cultural diversity of India, showcasing the unique traditions of Kerala. The festival teaches about gratitude, prosperity, and the importance of remembering good rulers and values. The elaborate Onam Sadya (feast) represents the importance of food and sharing in Indian culture.',
    traditions: ['Pookalam (flower rangoli)', 'Onam Sadya (grand feast with 26+ dishes)', 'Snake boat races (Vallamkali)', 'Traditional dances (Kathakali, Pulikali)', 'Tug of war and other games'],
    location: 'Kerala',
    color: '#FF6B6B',
    imageUrl: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop'
  },
  ...
  // OCTOBER 2026
  {
    ...
    date: new Date(2026, 9, 11), // October 11, 2026 (first day)
    type: 'festival',
  ...
  },
  {
    ...
    date: new Date(2026, 9, 26), // October 26, 2026
    type: 'fast',
  ...
  // NOVEMBER 2026
  {
    ...
    date: new Date(2026, 10, 8), // November 8, 2026
    type: 'festival',
  ...
  },
  {
    ...
    date: new Date(2026, 10, 15), // November 15, 2026
    type: 'festival',
  ...
  // DECEMBER 2026
  {
    ...
    description: 'Full moon day in the month of Margashirsha (November-December), considered auspicious for spiritual practices and charity. This day is associated with various deities and marks an important period in the Hindu calendar.',
    date: new Date(2026, 11, 15), // December 15, 2026
    type: 'festival',
    significance: 'An auspicious day for performing spiritual practices, charity, and rituals. The month of Margashirsha is considered sacred, and the full moon day is especially significant for worship and meditation.',
    culturalContext: 'Margashirsha Purnima reflects the Indian practice of observing auspicious lunar days for spiritual activities. The festival teaches about the importance of timing in spiritual practices and the cyclical nature of time in Hindu philosophy.',
    traditions: ['Performing puja and prayers', 'Charity and donations', 'Fasting and spiritual practices', 'Visiting temples', 'Lighting lamps'],
    location: 'Pan-India',
    color: '#87CEEB',
    imageUrl: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop'
  },
  {
    id: '25',
    name: 'Geeta Jayanti',
    description: 'Celebrates the day when Lord Krishna delivered the Bhagavad Gita to Arjuna on the battlefield of Kurukshetra. This day honors one of the most important philosophical texts in Hinduism.',
    date: new Date(2026, 11, 29), // December 29, 2026
    type: 'festival',
    significance: 'Commemorates the day when Lord Krishna imparted the wisdom of the Bhagavad Gita to Arjuna. The Gita is considered one of the most important spiritual texts, teaching about duty, devotion, and the path to liberation.',
    culturalContext: 'Geeta Jayanti reflects the importance of the Bhagavad Gita in Indian philosophy and culture. The text has influenced not just Hinduism but global philosophy, teaching about duty, detachment, and spiritual wisdom. The festival celebrates the timeless wisdom that continues to guide millions.',
    traditions: ['Reading the Bhagavad Gita', 'Discourses and lectures on the Gita', 'Performing puja', 'Meditation and reflection', 'Visiting Kurukshetra'],
    location: 'Pan-India (especially Kurukshetra)',
    color: '#4169E1',
    imageUrl: 'https://images.unsplash.com/photo-1528164344705-47542687000d?w=800&h=600&fit=crop'
  }
];
